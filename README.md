...
release on the bugfree repository's Releases page with the tag `v0.9.6` publishes
...
pushes this directory to that repository as one commit, tags it there as `v0.9.6`
